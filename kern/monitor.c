...
static struct Command commands[] = {
	...
	{"showmappings", "Display mapping info", mon_showmappings},
	{"setperm", "Display setperm info", mon_setperm},
	{"showvm", "Display showvm info", mon_showvm},
};
...
monitor(struct Trapframe *tf)
{
	...
	cprintf("Welcome to the mjos kernel monitor!\n");
